...
public interface IEditConfiguration<T extends IUnmodifiableName>
		extends IPersistenceEdition<T>, IAvailableEdition<IEditConfiguration<T>>,
		INodeEdition<IMapEdition<T>, IEditConfiguration<T>>, IMessageSender<IEditConfiguration<T>>, IObsPersistence<T> {
